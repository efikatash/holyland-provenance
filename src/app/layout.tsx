...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Shofar Philippines",
    "Holy Land shofar Philippines",
    "Anointing oil from the Holy Land Philippines",
    "Christian gifts from the Holy Land Philippines",
    "Bible study gifts Philippines",
    "Holy Land provenance",
    "Holy Land origin religious gifts",
